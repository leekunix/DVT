...
static const SERVER_ROUTINE InterfaceName_ServerRoutineTable[] = 
    ...
    (SERVER_ROUTINE)OpenNewSegFile,
    (SERVER_ROUTINE)CloseSegFile,
    (SERVER_ROUTINE)DoEncode,
    (SERVER_ROUTINE)SetVideoType,
    (SERVER_ROUTINE)SetPicturesData,
    (SERVER_ROUTINE)SetPictureInfo,
    (SERVER_ROUTINE)AsyncFunc,
    (SERVER_ROUTINE)OpenCompressedData,
    (SERVER_ROUTINE)CloseCompressedData,
    (SERVER_ROUTINE)GetCompressedDataInfo,
    (SERVER_ROUTINE)GetCompressedData
    };
