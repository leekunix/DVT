...
// es-extraction-filter.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
// 유일한 CesextractionfilterApp 개체입니다.

CesextractionfilterApp theApp;


// CesextractionfilterApp 초기화
...
// CesextractionfilterApp 메시지 처리기
